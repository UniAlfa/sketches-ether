                ...
                <Typography variant="subheading" align="center">
                    ...
                    <div className="cards">
                        <Grid container spacing={24} style={{ "justifyContent": "center" }}>
                            <Grid item xs={8} sm={4}>
                    <InfoCard count={5000} imageUrl={'/images/card-members.jpg'} title={'Участников форума'} cardStyle={{"backgroundColor": "#f6ebcd" }}/>
                            </Grid>
                            <Grid item xs={8} sm={4}>

                    <InfoCard count={this.state.walCount} imageUrl='images/card-etherium.jpg' title={'Кошельков Ethereum'} cardStyle={{"backgroundColor": "#cbc2d2", backgroundSize: '50%' }}/>
                            </Grid>

                            <Grid item xs={8} sm={4}>
                    <InfoCard count={500} imageUrl='/images/card-books.jpg' title={'Книг в магазинах Сбербанка'} cardStyle={{"backgroundColor": "#a1dce4" }}/>
                            </Grid>
                        </Grid>
                    </div>
