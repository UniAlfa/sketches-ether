...
export class AccountRow extends React.Component {
    render() {
            let url = 'https://ropsten.etherscan.io/address/' + this.props.username;
                ...
                case 'admin':
                    return (
                        <TableRow style={style}>
                            <TableCell className={'sketch-tbody'}><a href={url} target={'_blank'}>{this.props.username}</a></TableCell>
